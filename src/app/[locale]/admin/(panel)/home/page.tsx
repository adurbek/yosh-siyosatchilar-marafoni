...
const btnCls =
  "rounded-lg bg-[#0f2a56] px-5 py-2 text-sm font-semibold text-white hover:bg-[#15376e]";
const delBtnCls =
          ...
          <div className="space-y-2">
            {videos.map((v) => (
              <div key={v.id} className="rounded-lg border border-slate-200 bg-white p-3 shadow-sm">
                <a href={v.src} target="_blank" rel="noreferrer" className="block truncate text-xs text-blue-600 hover:underline">
                  {v.src}
                </a>
